...
/* clang targeting *-windows-msvc (incl. clang-cl) predefines __wchar_t
   itself as a builtin type identical to what these branches would
   declare, and rejects re-typedefing a reserved builtin name. */
#ifndef _MSC_VER
